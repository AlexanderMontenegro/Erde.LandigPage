...
export default function Home() {
  ...
  // Filtra promociones (asume product.discount > 0)
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <section id="quienes-somos" className="mt-12">
        ...
        <p className="text-lg">Somos una tienda de productos impresos en 3D inspirados en gaming y anime. ¡Personaliza tu setup otaku!</p>
      </section>
      ...
      <section id="contacto" className="mt-12">
        ...
        <form className="flex flex-col gap-4">
          <input type="text" placeholder="Nombre" className="p-2 bg-dark-input" />
          <input type="email" placeholder="Email" className="p-2 bg-dark-input" />
          <textarea placeholder="Mensaje" className="p-2 bg-dark-input" />
          <button type="submit" className="bg-neon-green p-2 rounded glow-hover">Enviar</button>
        </form>
      </section>
